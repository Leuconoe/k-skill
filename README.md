...
| 서울 기상 위험 시간대 조회 | `seoul-weather-risk` | ASK 서울 API로 장소별 폭염·한파·호우·대설·강풍 후보 예보 시간대와 판정 근거 조회 (기상청 공식 특보 아님) | 필요 | [서울 기상 위험 시간대 조회 가이드](docs/features/seoul-weather-risk.md) |
